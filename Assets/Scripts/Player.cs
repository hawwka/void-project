...
public class Player : MonoBehaviour
{
    ...
    //         return;
    //     
    //     SelectedAttackable.gameObject.GetComponentInChildren<Renderer>().enabled = false;
    //     SelectedAttackable = weapons[weaponIndex];
    //     SelectedAttackable.gameObject.GetComponentInChildren<Renderer>().enabled = true;
    // }
